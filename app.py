...
def upload_file():
    if request.method == 'POST':
        ...
        if file:
            ...
            upload_params = upload_response['data']['parameters']
            ...
            job_payload = {
                "tasks": {
                    ...
                    "convert-to-png": {
                        ...
                        "engine": "office",
                        "output": {
                            "resize": {"resize_mode": "fit", "height": 3070}
                        }
                    },
                    "convert-to-jpg": {
                        "operation": "convert",
                        ...
                        "engine": "office",
                        "output": {
                            "resize": {"resize_mode": "fit", "height": 90}
                        }
                    },
                    "export-png": {
            ...
            return f'Job criado com sucesso! ID: {job_id}'
